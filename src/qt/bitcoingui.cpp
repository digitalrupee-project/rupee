                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DigitalRupees Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DigitalRupees address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and digitalrupees: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DigitalRupees Core"), this);
    aboutAction->setStatusTip(tr("Show information about DigitalRupees Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DigitalRupees"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DigitalRupees addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DigitalRupees addresses"));
    ...
    openAction->setStatusTip(tr("Open a DigitalRupees: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DigitalRupees Core help message to get a list with possible DigitalRupees command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DigitalRupees Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DigitalRupees network", "", count));
}
...
{
    QString strTitle = tr("DigitalRupees Core"); // default title
