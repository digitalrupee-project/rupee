...
/** Utility functions used by the DigitalRupees Qt UI.
 */
namespace GUIUtil
{
...
// Render DigitalRupees addresses in monospace font
...
// Parse "digitalrupees:" URI into recipient object, return true on successful parsing
