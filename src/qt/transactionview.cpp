 ...
 */
    ...
    typeWidget->addItem(tr("Received Phr from zDrs"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zDrs"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDrs));
