...
for example: alertnotify=echo %%s | mail -s "Phore Alert" admin@foo.com
        ...
        <translation>Um digitalrupeesd oder die -server option in phore-qt zu nutzen, muss ein RPC-Passwort mittels rpcpassword in der Konfigurationsdatei gestzt werden:
%s
