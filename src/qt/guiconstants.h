...
/* DigitalRupees GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DigitalRupees"
#define QAPP_ORG_DOMAIN "digitalrupees.org"
#define QAPP_APP_NAME_DEFAULT "DigitalRupees-Qt"
#define QAPP_APP_NAME_TESTNET "DigitalRupees-Qt-testnet"
