...
DIGITALRUPEESD_PROC_WAIT_TIMEOUT = 60
...
def initialize_datadir(dirname, n):
    ...
    with open(os.path.join(datadir, "digitalrupees.conf"), 'w', encoding='utf8') as f:
        f.write("regtest=1\n")
        f.write("server=1\n")
...
def initialize_chain(test_dir, num_nodes):
    ...
    for i in range(num_nodes):
        ...
        initialize_datadir(test_dir, i) # Overwrite port/rpcport in digitalrupees.conf
...
def start_node(i, dirname, extra_args=None, rpchost=None, timewait=None, binary=None):
    ...
    digitalrupeesd_processes[i] = subprocess.Popen(args)
    if os.getenv("PYTHON_DEBUG", ""):
        print("start_node: digitalrupeesd started, waiting for RPC to come up")
