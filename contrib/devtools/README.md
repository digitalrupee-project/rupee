...
Phore-Project/Phore repository.
...
Setup
---------
Configuring the github-merge tool for the Phore repository is done in the following way:

    git config githubmerge.repository Phore-Project/Phore
...
A script to optimize png files in the Phore
