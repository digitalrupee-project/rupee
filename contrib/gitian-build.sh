...
VERSION=
commit=false
url=https://github.com/digitalrupeesproject/digitalrupees
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the digitalrupees, gitian-builder, gitian.sigs, and digitalrupees-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/digitalrupeesproject/digitalrupees
...
then
	# Make output folder
	mkdir -p "./digitalrupees-binaries/${VERSION}"
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit digitalrupees=${COMMIT} --url digitalrupees=${url} ../digitalrupees/contrib/gitian-descriptors/gitian-linux.yml
	    ...
	    mv build/out/digitalrupees-*.tar.gz build/out/src/digitalrupees-*.tar.gz ../digitalrupees-binaries/${VERSION}
	fi
	# Windows
	if [[ $windows = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit digitalrupees=${COMMIT} --url digitalrupees=${url} ../digitalrupees/contrib/gitian-descriptors/gitian-win.yml
	    ...
	    mv build/out/digitalrupees-*.zip build/out/digitalrupees-*.exe ../digitalrupees-binaries/${VERSION}
	fi
	# Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit digitalrupees=${COMMIT} --url digitalrupees=${url} ../digitalrupees/contrib/gitian-descriptors/gitian-osx.yml
	    ...
	    mv build/out/digitalrupees-*.tar.gz build/out/digitalrupees-*.dmg ../digitalrupees-binaries/${VERSION}
	fi
	# AArch64
	if [[ $aarch64 = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit digitalrupees=${COMMIT} --url digitalrupees=${url} ../digitalrupees/contrib/gitian-descriptors/gitian-aarch64.yml
	    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../digitalrupees/contrib/gitian-descriptors/gitian-aarch64.yml
	    mv build/out/digitalrupees-*.tar.gz build/out/src/digitalrupees-*.tar.gz ../digitalrupees-binaries/${VERSION}
	fi
	popd || exit
...
then
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../digitalrupees/contrib/gitian-descriptors/gitian-win-signer.yml
	    ...
	    mv build/out/digitalrupees-*win64-setup.exe ../digitalrupees-binaries/${VERSION}
	    mv build/out/digitalrupees-*win32-setup.exe ../digitalrupees-binaries/${VERSION}
	fi
	# Sign Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=${COMMIT} ../digitalrupees/contrib/gitian-descriptors/gitian-osx-signer.yml
	    ...
	    mv build/out/digitalrupees-osx-signed.dmg ../digitalrupees-binaries/${VERSION}/digitalrupees-${VERSION}-osx.dmg
	fi
	popd || exit
