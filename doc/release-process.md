...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/digitalrupeesproject/Phore/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Phore Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit digitalrupees=v${VERSION} ../digitalrupees/contrib/gitian-descriptors/gitian-win.yml
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/digitalrupeesproject/Phore/releases/new) with a link to the archived release notes.
