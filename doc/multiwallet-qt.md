...
In order to support loading of multiple wallets in digitalrupees-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is digitalrupees.cpp.
...
Changes to digitalrupees.cpp
----------------------
digitalrupees.cpp is the entry point into digitalrupees-qt, and as such, will require some minor modifications to provide hooks for
