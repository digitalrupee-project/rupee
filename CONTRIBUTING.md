Contributing to DigitalRupees Core
============================

The DigitalRupees Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DigitalRupees Core project, and is not to be
confused with overall DigitalRupees Network Protocol consensus changes.

Whether a pull request is merged into DigitalRupees Core rests with the project merge
...
Patches that change DigitalRupees consensus rules are considerably more involved than
...
Where a patch set proposes to change the DigitalRupees consensus, it must have been
...
The project leader is the release manager for each DigitalRupees Core release.
